...
class _BillHistoryScreenState extends State<BillHistoryScreen> {
  ...
  late List<GetBillItem> _filterBills;
  late BillController billsProvider;
  final TextEditingController searchController = TextEditingController();

  @override
  void initState() {
    super.initState();
    billsProvider = Provider.of<BillController>(context, listen: false);
                ...
                children: [
                  ...
                  Expanded(
                    child: _filterBills.isEmpty
                        ? RefreshIndicator(
                            onRefresh: () async {
                              billsProvider = Provider.of<BillController>(
                                  context,
                                  listen: false);
                              await billsProvider.fetchBillsPage(context);
                              ...
                              itemBuilder: (context, index) {
                                ...
                                return InkWell(
                                  onTap: () {
                                    ...
                                    Navigator.pushNamed(
                                        context, AppRoutes.previewScreen,
